...
| best_coverage_pair | add_h1.6_Bxyz@1.0 |
...
| regularization_beats_ols_by_0_20 | True |
| all_regularized_gates_pass | False |
| best_regularized_coverage_pair | add_h6.4_Bz:ridge@λ=1e+00 |
| calibration_eval_vdr_nondegenerate | False |
...
- baseline_effective_rank: 18
- best_candidate: add_h6.4_Bz
- runtime_s: 1.1
